...
final class SignatureTypeSeeder extends Seeder
{
    ...
    private function seedRelicSites(): void
    {
        $sites = [
            ...
            ['name' => 'Ruined Angel Crystal Quarry', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Ruined Angel Monument Site', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Ruined Angel Science Outpost', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Ruined Angel Temple Site', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Ruined Blood Raider Crystal Quarry', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Ruined Blood Raider Monument Site', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Ruined Blood Raider Science Outpost', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Ruined Blood Raider Temple Site', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Ruined Guristas Crystal Quarry', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Ruined Guristas Monument Site', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Ruined Guristas Science Outpost', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Ruined Guristas Temple Site', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Ruined Sansha Crystal Quarry', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Ruined Sansha Monument Site', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Ruined Sansha Science Outpost', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Ruined Sansha Temple Site', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Ruined Serpentis Crystal Quarry', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Ruined Serpentis Monument Site', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Ruined Serpentis Science Outpost', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Ruined Serpentis Temple Site', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
    ...
    private function seedDataSites(): void
    {
        $sites = [
            ...
            ['name' => 'Abandoned Research Complex DA005', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Abandoned Research Complex DA015', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Abandoned Research Complex DC007', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Abandoned Research Complex DC021', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Abandoned Research Complex DC035', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Abandoned Research Complex DG003', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Central Angel Command Center', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Central Angel Data Mining Site', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Central Angel Sparking Transmitter', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Central Angel Survey Site', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Central Blood Raider Command Center', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Central Blood Raider Data Mining Site', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Central Blood Raider Sparking Transmitter', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Central Blood Raider Survey Site', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Central Guristas Command Center', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Central Guristas Data Mining Site', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Central Guristas Sparking Transmitter', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Central Guristas Survey Site', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Central Sansha Command Center', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Central Sansha Data Mining Site', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Central Sansha Sparking Transmitter', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Central Sansha Survey Site', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Central Serpentis Command Center', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Central Serpentis Data Mining Site', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Central Serpentis Sparking Transmitter', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            ['name' => 'Central Serpentis Survey Site', 'spawn_areas' => [SolarsystemClass::C1, SolarsystemClass::C2, SolarsystemClass::C3]],
            // Ghost sites
