...
final class SignatureTypeFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'category' => $category,
            'target_class' => $category === SignatureCategory::Wormhole ? $this->faker->randomElement(WormholeTargetClass::cases()) : null,
            'extra' => $this->faker->optional(0.3)->word(),
            'spawn_areas' => $this->faker->randomElements(WormholeClass::cases(), $this->faker->numberBetween(1, 4)),
        ];
    }
    ...
    public function wormhole(): static
    {
        return $this->state(fn (array $attributes) => [
            ...
            'target_class' => $this->faker->randomElement(WormholeTargetClass::cases()),
        ]);
    }
