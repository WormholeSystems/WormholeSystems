...
export const signatureCategoryById = new Map(
    signatureCategories.map(cat => [cat.id, cat])
);

export const signatureCategoryByName = new Map(
    signatureCategories.map(cat => [cat.name, cat])
);

export const signatureCategoryByCode = new Map(
    signatureCategories.map(cat => [cat.code, cat])
);

export const signatureTypeById = new Map(
    signatureTypes.map(type => [type.id, type])
);

export const signatureTypesByCategory = signatureTypes.reduce((acc, type) => {
...
export const signatureTypesByCategoryName = signatureTypes.reduce((acc, type) => {
