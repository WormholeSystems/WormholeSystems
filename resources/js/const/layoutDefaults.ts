...
export const DEFAULT_BREAKPOINTS: BreakpointsConfig = {
    xs: {
        ...
        items: [
            ...
            { i: 'signatures', x: 0, y: 11, w: 1, h: 3, minH: 2, static: false },
            { i: 'killmails', x: 0, y: 14, w: 1, h: 3, minH: 2, static: false },
            ...
            { i: 'solarsystem', x: 0, y: 24, w: 1, h: 3, minH: 2, static: false },
    ...
    sm: {
        ...
        items: [
            ...
            { i: 'system-info', x: 0, y: 8, w: 1, h: 3, minH: 2, static: false },
            { i: 'signatures', x: 1, y: 8, w: 1, h: 3, minH: 2, static: false },
            { i: 'killmails', x: 0, y: 11, w: 1, h: 3, minH: 2, static: false },
            { i: 'autopilot', x: 1, y: 11, w: 1, h: 4, minH: 2, static: false },
            { i: 'eve-scout', x: 0, y: 14, w: 2, h: 3, minH: 2, static: false },
            // Permission-gated cards (bottom — hidden for guests/viewers)
            { i: 'solarsystem', x: 0, y: 17, w: 1, h: 3, minH: 2, static: false },
    ...
    md: {
        ...
        items: [
            ...
            { i: 'signatures', x: 2, y: 8, w: 2, h: 3, minH: 2, static: false },
            { i: 'killmails', x: 0, y: 11, w: 2, h: 3, minH: 2, static: false },
    ...
    lg: {
        ...
        rowHeight: 100,
        items: [
            { i: 'map', x: 0, y: 0, w: 7, h: 8, minH: 3, static: false },
            { i: 'signatures', x: 7, y: 0, w: 3, h: 4, minH: 2, static: false },
            { i: 'autopilot', x: 7, y: 4, w: 3, h: 4, minH: 2, static: false },
            { i: 'system-info', x: 0, y: 8, w: 3, h: 3, minH: 2, static: false },
