...
/**
 * Shared system-search used by the search box and the add-connection dialog: filters the
 * static system list by name and splits it into systems not yet on the map and ones that
 * already are. Takes the map's systems as a getter so it isn't tied to a single page shape.
 */
