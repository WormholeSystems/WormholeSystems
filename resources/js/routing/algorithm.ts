import type { ClosestSystem, ConnectionType, RouteResult, RouteStep, RoutingConnection, RoutingInitPayload, RoutingSettings } from '@/routing/types';
...
export function setStaticData(payload: RoutingInitPayload): void {
