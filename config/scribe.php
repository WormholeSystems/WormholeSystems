...
return [
    ...
    'description' => 'RESTful API for managing wormhole maps and solar system data in EVE Online. Access and manipulate collaborative mapping data for navigating wormhole space.',
    ...
    'auth' => [
        ...
        'extra_info' => 'You can retrieve your personal access token by logging into the application, navigating to your account settings, and creating a new API token in the <b>API Tokens</b> section.',
    ],
