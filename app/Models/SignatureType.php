...
use App\Casts\WormholeClassArrayCast;
 ...
 * @property WormholeTargetClass|null $target_class For wormholes, the target wormhole class (e.g., "C1", "H", "L", "N")
 * @property string|null $extra Additional information (e.g., "Thera", "Barbican", "Pochven")
 * @property array<WormholeClass>|null $spawn_areas Array of wormhole classes where this signature can appear
...
final class SignatureType extends Model
{
    ...
    protected $casts = [
        ...
        'target_class' => WormholeTargetClass::class,
        'spawn_areas' => WormholeClassArrayCast::class,
