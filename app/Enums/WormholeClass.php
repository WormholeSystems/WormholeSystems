...
enum WormholeClass: string
{
    ...
    /**
     * Get a human-readable label for the wormhole class.
     */
    public function label(): string
    {
        return match ($this) {
            ...
            self::HighSec => 'High Security',
            self::LowSec => 'Low Security',
            self::NullSec => 'Null Security',
    ...
    {
        return $this->isStandard() || $this->isSpecial();
    }
}
