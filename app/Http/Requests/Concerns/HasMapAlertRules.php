...
trait HasMapAlertRules
{
    ...
    protected function alertRules(): array
    {
        ...
        return [
            ...
            'target_solarsystem_id' => ['nullable', 'integer', 'exists:solarsystems,id', 'required_if:type,'.MapAlertType::Proximity->value.','.MapAlertType::JumpRange->value, 'prohibited_if:type,'.MapAlertType::MaintainerPodium->value],
            'origin_solarsystem_id' => ['nullable', 'integer', 'exists:solarsystems,id', 'prohibited_unless:type,'.MapAlertType::Proximity->value],
            'ship_type' => ['nullable', Rule::enum(JumpShipType::class), 'required_if:type,'.MapAlertType::JumpRange->value, 'prohibited_if:type,'.MapAlertType::MaintainerPodium->value],
            'jdc_level' => ['nullable', 'integer', 'between:1,5', 'required_if:type,'.MapAlertType::JumpRange->value, 'prohibited_if:type,'.MapAlertType::MaintainerPodium->value],
            'include_highsec' => ['boolean'],
            'max_jumps' => ['nullable', 'integer', 'between:1,20', 'required_unless:type,'.MapAlertType::JumpRange->value.','.MapAlertType::MaintainerPodium->value],
